...
public class Practica extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                Practica.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Practica.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                Practica.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Practica.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                Practica.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                Practica.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        guidatabase.Customer c = list.get(masterTable.convertRowIndexToModel(index));
        Collection<guidatabase.PurchaseOrder> ps = c.getPurchaseOrderList();
        int[] selected = detailTable.getSelectedRows();
        List<guidatabase.PurchaseOrder> toRemove = new ArrayList<guidatabase.PurchaseOrder>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {

            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);

            int count = 0;
            Iterator<guidatabase.PurchaseOrder> iter = ps.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            guidatabase.PurchaseOrder p = iter.next();
            toRemove.add(p);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<guidatabase.PurchaseOrder> ps = c.getPurchaseOrderList();
        if (ps == null) {
            ps = new LinkedList<guidatabase.PurchaseOrder>();
            c.setPurchaseOrderList((List) ps);
        }
        guidatabase.PurchaseOrder p = new guidatabase.PurchaseOrder();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<guidatabase.Customer> toRemove = new ArrayList<guidatabase.Customer>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            guidatabase.Customer c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        guidatabase.Customer c = new guidatabase.Customer();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<guidatabase.Customer> merged = new ArrayList<guidatabase.Customer>(list.size());
            for (guidatabase.Customer c : list) {
    ...
    private java.util.List<guidatabase.Customer> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new Practica());
